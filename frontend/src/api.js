...
export function updateAlbumDescription(albumId, description, token) {
  return apiFetch(`/rest/x-banana/albums/${encodeURIComponent(albumId)}/description`, {
    method: 'PUT',
...
export function downloadTrackUrl(trackId) {
